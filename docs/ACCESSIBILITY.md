...
10. Confirm event date, time, location, and registration remain understandable without color or icons. Opportunity type, deadline, location, and posting link should also remain understandable without color or icons. Conference date, location, and meeting link should remain understandable without color or icons. Calendar subscribe and add-to-calendar links should remain understandable without color or icons.
